...
class ListaSimplesDinamica {
    ...
    // Inserir uma musica em uma posicao determinada
    public void inserir(Musica musica, int posicao) throws Exception {
        int tamanho = tamanho();

        if (posicao < 0 || posicao > tamanho) {
            throw new Exception("Erro !!! posicao menor que 0 OU posicao maior que tamanho");
        } else if (posicao == 0) {
    ...
    // Remover uma musica do inicio da lista
    public Musica removerInicio() throws Exception {
        // Verificar se a lista esta vazia
        if (primeiro == ultimo) {
            throw new Exception("Erro !!! primeiro igual a ultimo");
        }

        Celula tmp = primeiro;
        primeiro = primeiro.prox; // Ou primeiro.prox.prox
        Musica elemento = primeiro.elemento.clone();
        tmp.prox = null;
        tmp = null;
    ...
    public Musica removerFim() throws Exception {
        ...
        Musica elemento = ultimo.elemento.clone();
        ultimo = i;
        i = null;
        ultimo.prox = null;
    ...
    public Musica remover(int posicao) throws Exception {
        ...
        if (primeiro == ultimo || posicao < 0 || posicao >= tamanho) {
            throw new Exception("Erro !!! primeiro igual a ultimo OU posicao menor que 0 OU posicao maior ou igual a tamanho");
        } else if (posicao == 0) {
            removerInicio();
...
public class TP03Q04 {
    ...
    public static ListaSimplesDinamica searchIdInReturnSimpleListDynamic(Musica[] musica, ListaSimplesDinamica lista, String[] id, int numEntrada) {
        boolean achou = false;
    ...
    public static void createLog(Tempo tempo) {
        Arq.openWrite("DadosQuestao04.txt");
    ...
    public static ListaSimplesDinamica tratarComandos(String[] entrada, ListaSimplesDinamica lista, Musica[] musica, int tamanho) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListaSimplesDinamica music = new ListaSimplesDinamica();

        //Iniciar o relogio
        time.start();

        //Criar as musicas pedidas
        music = searchIdInReturnSimpleListDynamic(m, music, entrada, i);
