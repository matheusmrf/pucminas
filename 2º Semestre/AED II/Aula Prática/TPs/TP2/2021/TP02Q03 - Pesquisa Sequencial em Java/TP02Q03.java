...
public class TP02Q03 {
    ...
    public static Musica[] searchIdInFile(String[] id, int numEntrada) {
        Musica[] m = new Musica[tamanho];
        m = createAllObject();
    ...
    public static void createLog(Tempo tempo) {
        ...
        Arq.println("Matricula: 716417\tTempo: "+ tempo.getTime() + "s \tComparacoes: " + comparisons);
    ...
    public static void main(String[] args) {
        ...
        time.start();
        //Musica[] music = new Musica[tamanho];
        MyIO.setCharset("UTF-8");
        
        String[] entrada = new String[301];
        ...
        //music = createAllObject();
    
        for (int k = 0; k < j; k++) {
            if (sequentialSearch(entrada, segundaEntrada[k]) == true) {
                MyIO.println("SIM");
            } else {
                MyIO.println("NAO");
            }
