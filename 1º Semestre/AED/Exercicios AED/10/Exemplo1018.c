...
bool iguais ( ref_int_Matrix matrix, ref_int_Matrix other )
{
// definir dados locais
   bool result = true;
...
void method18 ()
{
   ...
   fprintIntMatrix( "RESULTADO18_1.TXT", matrix );

   printf("\nmatriz 2:\n");
   other = IO_readintMatrix ( );
   fprintIntMatrix( "RESULTADO18_2.TXT", other );
   ...
   {
      printf("\nMatrizes iguais ? %s", iguais( matrix, other ) ? "SIM" : "NAO");
   }
   else
   {
      printf("ERRO: AS MATRIZES DEVEM SER DE MESMO TAMANHO");
   }
