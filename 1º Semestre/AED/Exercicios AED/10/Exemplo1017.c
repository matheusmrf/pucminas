...
bool TodosZeros ( ref_int_Matrix matrix )
{
// definir dados locais
   bool result = true;
...
// definir dados
   ref_int_Matrix matrix = NULL;
// identificar
   IO_id ( "EXEMPLO1017 - Method17 - v0.0" );
// ler dados
   matrix = freadintMatrix ( "RESULTADO16.TXT" );
// mostrar dados
   IO_printf ( "\n" );
   printIntMatrix ( matrix );
   printf("\nTodos 0 ? %s", TodosZeros( matrix ) ? "SIM" : "NAO");
// reciclar espaco
