...
void method11 ( )
{
   ...
   int quantidade = IO_readint("Digita uma quantidade ai:");
   impar ( quantidade );
   IO_pause ( "Apertar ENTER para continuar" );
}

void multiplo3 ( int x )
{
   if(x % 3 == 0)
   {
      IO_printf ( "%d\n", x );
...
{
   int quantidade = IO_readint("Digita uma quantidade ai:");
   IO_id ( "EXEMPLO0612 - Method01 - v0.0" );
   multiplo3 ( quantidade );
   IO_pause ( "Apertar ENTER para continuar" );
}

void cincoemcinco ( int x )
{
   if ( x > 1)
   {
      cincoemcinco ( x - 1 );
...
{
   int quantidade = IO_readint("Digita uma quantidade ai:");
   IO_id ( "EXEMPLO0613 - Method01 - v0.0" );
   cincoemcinco ( quantidade );
   IO_pause ( "Apertar ENTER para continuar" );
}



double potenciado3 ( int x )
{
   if ( x > 1 )
   {
      IO_printf ( "%d: %2.2lf/%2.2lf\n", x, (1.0), (pow(3,x)) );
...
{
   int quantidade = IO_readint("Digita uma quantidade ai: ");
   IO_id ( "EXEMPLO0614 - Method01 - v0.0" );
   potenciado3 ( quantidade );
   IO_pause ( "Apertar ENTER para continuar" );
}

double simbolos ( chars cadeia, int x )
{
// definir dado
   int resposta = 0;
// testar se contador valido
...
void method15 ( )
{
   chars palavra = IO_readstring("Digita uma palavra ai: ");
   IO_id ( "EXEMPLO0615 - Method01 - v0.0" );
   simbolos ( palavra, 0 );
   IO_pause ( "Apertar ENTER para continuar" );
}

double SomaImpares( int x )
{
// definir dado local
   double soma = 0.0;
// repetir enquanto valor maior que zero
   if ( x > 2 )
   {
      soma = (1.0*(x-1)+1) + SomaImpares ( x - 1 );
   }
   if( x % 2 != 0 )
   {
...
{
   double soma = 0.0;
   IO_id ( "EXEMPLO0616 - Method06 - v0.0" );
   double quantidade = IO_readdouble("Digita uma quantidade ai:");
   soma = SomaImpares ( quantidade );
   IO_printf ( "soma = %2.2lf\n", soma );
   IO_pause ( "Apertar ENTER para continuar" );
}

double inversodosimpares ( int x )
{
// definir dado local
   double soma = 0.0;
// repetir enquanto valor maior que zero
   if ( x > 2  && x % 2 != 0)
   {
      soma = 1/(1.0*(x-1)+1) + inversodosimpares ( x - 1 );
      IO_printf ( "%d: %2.2lf/%2.2lf\n", x, 1, (1.0*(x-1)+1) );
   }
   return ( soma );
}
void method17 ( )
{
   ...
   double quantidade = IO_readdouble("Digita uma quantidade ai:");
   soma = inversodosimpares ( quantidade );
   IO_printf ( "soma = %2.2lf\n", soma );
   IO_pause ( "Apertar ENTER para continuar" );
}
...
void method18 ( )
{
   ...
   IO_id ( "nao consegui fazer" );        // SUGESTAO: DIVIDIR EM DOIS METODOS.
   IO_pause ( "Apertar ENTER para continuar" );
}
...
void method19 ( )
{
   ...
   IO_id ( "nao consegui fazer" );
   IO_pause ( "Apertar ENTER para continuar" );
}

int contarMaiusculas ( chars cadeia, int x )
{
   int resposta = 0;
   if ( 0 <= x && x < strlen ( cadeia ) )
   {
      ...
      resposta = resposta + contarMaiusculas ( cadeia, x+1 );
   }
   return ( resposta );
}
void method20 ( )
...
// repetir até desejar parar
   ...
   {
   // identificar
      IO_id ( "Exemplo0620 - Programa - v0.0" );
   // ler do teclado
      IO_println ( "Opcoes" );
      IO_println ( " 0 - parar" );
